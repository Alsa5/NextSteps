...
export function Header({ unlockedCount, totalXp, streak, xpGainKey, onReset }: HeaderProps) {
  ...
  return (
    <header className="absolute left-4 top-4 z-20 font-space">
      <motion.div
      ...
      >
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="neon-text text-lg font-bold text-white">Universe Skill Unlocker</h1>
              <p className="mt-0.5 text-xs text-white/40">Explore the cosmos · Unlock your skills</p>
