export const ACHIEVEMENTS = [
  { id: 'first-steps', count: 2, emoji: '🌍', title: 'First Steps', subtitle: 'Welcome to the Universe' },
  { id: 'on-fire', count: 3, emoji: '🔥', title: 'On Fire', subtitle: "You're on a roll" },
  { id: 'halfway', count: 5, emoji: '⚡', title: 'Halfway There', subtitle: 'Halfway through the galaxy' },
  { id: 'galaxy-master', count: 8, emoji: '👑', title: 'Galaxy Master', subtitle: 'Universe conquered' },
] as const
...
const DAILY_KEY = 'universe-daily'
...
const DISMISSED_KEY = 'universe-daily-dismissed'
...
const ACHIEVEMENTS_KEY = 'universe-achievements'
